...
HelpMessage() unless $lidstatus;
HelpMessage() unless $lidlock;
HelpMessage() unless $createEventHandler;
HelpMessage() unless $createUdevHandler;
HelpMessage() unless $xrandrMirror;
HelpMessage() unless $sameResolution;
HelpMessage() unless $changeDPstatus;
